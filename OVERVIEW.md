...
> Index of entry points, key files, and data contracts. Companion to [README.md](README.md). System overview lives in [`nousergon-docs`](https://github.com/nousergon/nousergon-docs).
...
| Typed state schemas (Pydantic) | [`graph/state_schemas.py`](graph/state_schemas.py) — research-internal state + storage types; LLM-output schemas re-exported from `nousergon_lib.agent_schemas` (lifted 2026-05-05, lib v0.4.0) |
