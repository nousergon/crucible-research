...
Until then, instantiating this adapter raises a configuration error
so the aggregator's "skip-disabled-sources" pathway picks the right
posture without silent fallthrough.
"""
