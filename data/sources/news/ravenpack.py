...
sentiment + relevance scores on a per-(article, ticker) basis. Drop-in
implementation: REST/edgar endpoints under
https://docs.ravenpack.com/. When wired, this adapter's structured
output becomes the highest-trust news source (trust weight ~1.0).
"""
