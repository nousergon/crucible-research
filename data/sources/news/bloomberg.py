...
Stub for Phase 4. Bloomberg's institutional news feed is the highest-
quality source available; access requires a Terminal subscription +
the BPIPE/B-PIPE message bus or the Enterprise API. Drop-in
implementation when BBG_API_KEY (or LP equivalent) lands.
